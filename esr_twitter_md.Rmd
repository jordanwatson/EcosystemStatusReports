...
data <- dbFetch(dbSendQuery(con,"select tt.*,
  ...
  mutate(julian=as.numeric(julian),
         ...
         esr_region2=fct_relevel(as.factor(esr_region2),"Northern Bering Sea","Eastern Bering Sea"),
...
mylines_smooth3 <- ggplot() +
  geom_line(data=data %>% filter(year2<last.year & esr_region%in%(c("NBS","EBS"))),
            aes(newdate,meansst3,group=factor(year2),col='mygrey')) +
  geom_line(data=data %>% filter(year2==last.year & esr_region%in%(c("NBS","EBS"))),
            aes(newdate,meansst3,color='last.year.color'),size=1.15) +
  geom_line(data=data %>% 
              filter(year%in%mean.years & esr_region%in%(c("NBS","EBS"))) %>% 
              group_by(esr_region2,newdate) %>% 
            ...
            aes(newdate,meantemp,col='mean.color'),size=1) +
  geom_line(data=data %>% filter(year2==current.year & esr_region%in%(c("NBS","EBS"))),
            aes(newdate,meansst3,color='current.year.color'),size=1.15) +
  facet_wrap(~esr_region2,ncol=2) + 
  scale_color_manual(name="",
                     breaks=c('current.year.color','last.year.color','mygrey','mean.color'),
                     values=c('current.year.color'=current.year.color,'last.year.color'=last.year.color,'mygrey'='grey70','mean.color'=mean.color),
...
mylines_smooth5 <- ggplot() +
  geom_line(data=data %>% filter(year2<last.year & esr_region%in%(c("NBS","EBS"))),
            aes(newdate,meansst5,group=factor(year2),col='mygrey')) +
  geom_line(data=data %>% filter(year2==last.year & esr_region%in%(c("NBS","EBS"))),
            aes(newdate,meansst5,color='last.year.color'),size=1.15) +
  geom_line(data=data %>% 
              filter(year%in%mean.years & esr_region%in%(c("NBS","EBS"))) %>% 
              group_by(esr_region2,newdate) %>% 
            ...
            aes(newdate,meantemp,col='mean.color'),size=1) +
  geom_line(data=data %>% filter(year2==current.year & esr_region%in%(c("NBS","EBS"))),
            aes(newdate,meansst5,color='current.year.color'),size=1.15) +
  facet_wrap(~esr_region2,ncol=2) + 
  scale_color_manual(name="",
                     breaks=c('current.year.color','last.year.color','mygrey','mean.color'),
                     values=c('current.year.color'=current.year.color,'last.year.color'=last.year.color,'mygrey'='grey70','mean.color'=mean.color),
...
mylines_smooth7 <- ggplot() +
  geom_line(data=data %>% filter(year2<last.year & esr_region%in%(c("NBS","EBS"))),
            aes(newdate,meansst7,group=factor(year2),col='mygrey')) +
  geom_line(data=data %>% filter(year2==last.year & esr_region%in%(c("NBS","EBS"))),
            aes(newdate,meansst7,color='last.year.color'),size=1.15) +
  geom_line(data=data %>% 
              filter(year%in%mean.years & esr_region%in%(c("NBS","EBS"))) %>% 
              group_by(esr_region2,newdate) %>% 
            ...
            aes(newdate,meantemp,col='mean.color'),size=1) +
  geom_line(data=data %>% filter(year2==current.year & esr_region%in%(c("NBS","EBS"))),
            aes(newdate,meansst7,color='current.year.color'),size=1.15) +
  facet_wrap(~esr_region2,ncol=2) + 
  scale_color_manual(name="",
                     breaks=c('current.year.color','last.year.color','mygrey','mean.color'),
                     values=c('current.year.color'=current.year.color,'last.year.color'=last.year.color,'mygrey'='grey70','mean.color'=mean.color),
